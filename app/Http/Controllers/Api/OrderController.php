...
class OrderController extends BaseController
{
    ...
    public function preview()
    {
        ...
        // TODO 暂时模拟地址数据
        // $address = [
        //     ['id'=>1,'name'=>'tom','address'=>'北京','phone'=>'13322474666'],
        //     ['id'=>2,'name'=>'jon','address'=>'上海','phone'=>'13322474666'],
        //     ['id'=>3,'name'=>'lilu','address'=>'广州','phone'=>'13322474666'],];
    ...
    public function store(Request $request)
    {
        ...
        foreach ($carts as $key => $cart) {
            ...
            if ($cart->goods->stock < $cart->num) {
                ...
                ->errorBadRequest($cart->goods->title .'库存不足请重新选择商品');
            }
